      ...
      <div class="p-8 rounded-lg w-full max-w-md">
        ...
        <form name="contact" method="POST" data-netlify="true">
          ...
          <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-white text-black dark:bg-gray-800 dark:text-white" id="email" type="email" placeholder="Your email">
          </div>
          <div class="mb-4">
            <label class="block text-sm font-bold mb-2" for="message">Message</label>
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-white text-black dark:bg-gray-800 dark:text-white" id="message" placeholder="Your message"></textarea>
          </div>
